...
public class SpringDriver {
	...
	public static void main(String[] args) {
		...
		Teacher teacher = context.getBean("customName", HindiTeacher.class); // getBean(bean id , className.class)
		Teacher teacher1 = context.getBean("mathsTeacher",MathsTeacher.class);
		Teacher teacher2 = context.getBean("gkTeacher",GkTeacher.class);
